...
class MLP(nn.Module):
    def __init__(self, conf):
        ...
        # self.lin2_2 = nn.Linear(256, 512  )
        # self.lin3 = nn.Linear(512, self.board_size*self.board_size)

        # self.lin1 = nn.Linear(self.board_size*self.board_size, 1024)  # Increase the first layer size
        # self.lin2 = nn.Linear(1024, 512)  # Reduce later layers' size
        # self.lin2_2 = nn.Linear(512, 256)
